	...
	<script>	
		...
		$(document).ready(function() {
			...
			$("#myPurpose input:radio[name='purpose']:input[value='${study.purpose}']").attr('checked',true);
	 		...
	 		/* var extra_info= "${study.extra_info}";  */
									...
									<table>
										...
										<tr>
											...
											<td class="select-date">
												<div>
													<input type="text" id="deadLine" name="deadline" value='<fmt:formatDate value="${study.deadline}" type="date" pattern="YYYY-MM-dd"/>' >
												</div>
												<div>
								...
								<div class="table-indent">
									<table id="p_table">
										...
										<tr>
											...
											<td class="select-date">
												<div>
													<input type="text" id="startDate" name="start_date" value='<fmt:formatDate value="${study.start_date}" type="date" pattern="YYYY-MM-dd"/>'>
												</div>
											</td>	
										</tr>	
										<tr>
											...
											<td class="select-date">
												<div>
													<input type="text" id="endDate" name="end_date" value='<fmt:formatDate value="${study.end_date}" type="date" pattern="YYYY-MM-dd"/>'>
												</div>
											</td>	
										</tr>
									</table>
