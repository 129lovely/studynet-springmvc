					...
					<c:forEach var="study" items="${list}">
						...
						<div class="study-room-box ">
							<div>
								...
								<c:if test="${member.status eq '승인대기'}">
									<!-- if status == 승인대기 -->
									<div class="study-room ready-confirm">
										...
										<div class="accordion">
											<table class="study-info">
												...
												<tr>
													<th>개설자 명</th>
													<td>| ${study.create_idx}</td>
												</tr>
												<tr>
													<th>모집 기간</th>
													<td>| ${study.created_at} - ${study.deadline}</td>
												</tr>
												<tr>
													<th>모집 인원</th>
								...
								<c:if test="${member.status eq '승인거부'}">
									<!-- if status == 승인거부 -->
								...
								<c:if test="${member.status eq '개설대기중'}">
									<!-- if status == 개설 대기중 -->
								...
								<c:if test="${member.status eq '개설취소'}">
									<!-- if status == 개설 취소 -->
								...
								<c:if test="${member.status eq '진행중'}">
									<!-- if status == 진행중 -->
								...
								<c:if test="${member.status eq '폐쇄대기중'}">
									<!-- if status == 폐쇄 대기중 -->
								...
								<c:if test="${member.status eq '모집중'}">
									<!-- if status == 모집 중 -->
								...
								<c:if test="${member.status eq '마감가능'}">
									<!-- if status == 마감 가능 -->
								...
								<c:if test="${member.status eq '운영중'}">
									<!-- if status == 운영중 -->
