		...
		<div>
			<div class="inner-box pt190">
				<div class="contents-box board">
					...
					<div class="tac mb40">
						<input class="my-btn black-white mb20" type="button" value="메인페이지" onClick="index.do"/>
						<input class="my-btn yellow-black mb20" type="button" value="로그인 하기" onClick="user_login_form.do"/>
					</div>
				</div>
			</div>
